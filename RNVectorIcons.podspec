...
Pod::Spec.new do |s|
  ...
  s.homepage       = "https://github.com/mattcurrie/react-native-vector-icons"
  s.license        = "MIT"
  s.author         = { "Joel Arvidsson" => "joel@oblador.se" }
  s.platforms      = { :ios => "9.0", :tvos => "9.0" }
  s.source         = { :git => "https://github.com/mattcurrie/react-native-vector-icons.git", :tag => "v#{s.version}" }
